...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        ...
        return {
            ...
            # --- New keys added for Practical 04 (Step 3.1) ---
            # Expose opponent/trap positions so the agent's KB can reason
            # about tile-level Feasibility (safety), not just physical walls.
            'opponents': [tuple(op) for op in self.opponents],
...
if __name__ == "__main__":
    ...
    search_agent.heuristic_type = 'manhattan'  
